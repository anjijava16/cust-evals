...
This collection showcases 14 major evaluation frameworks, each with unique strengths.
...
| **General LLM Eval** | Claude, OpenAI Evals, DeepEval, MLflow |
| **Production Monitoring** | Langfuse, LangSmith, TruLens, Arize Phoenix |
| **CI/CD Integration** | DeepEval, OpenAI Evals, MLflow |
...
| **Custom Metrics** | Claude, OpenAI Evals, TruLens, Google ADK |
...
| **LLM-as-Judge** | Claude, Arize Phoenix, LangSmith, MLflow |
| **Dashboard/UI** | TruLens, LangSmith, Langfuse, Arize Phoenix, MLflow |
| **Observability** | TruLens, LangSmith, Langfuse, RAGalyst |
| **RAG-Specific** | RAGAS, ARES, RAGalyst, TruLens, Arize Phoenix |
| **Open Source** | RAGAS, ARES, OpenAI Evals, DeepEval, TruLens, MLflow |
| **Testing Framework** | DeepEval (Pytest), OpenAI Evals, MLflow |
| **Cloud-Native** | Vertex AI (GCP), LangSmith, Langfuse, Google ADK |
| **CLI-First** | Google ADK, OpenAI Evals |
| **Agent/Tool Evaluation** | Google ADK, MCPEval |
| **Synthetic Data** | ARES |
| **Prompt Management** | Langfuse, LangSmith |
| **Cost Tracking** | Langfuse, LangSmith |
...
### Production & MLOps
- **Need observability?** → Langfuse, TruLens, or LangSmith
- **Prompt management?** → Langfuse or LangSmith
- **ML lifecycle tracking?** → MLflow
- **Cost tracking?** → Langfuse or LangSmith
